...
```
/why what's the deal with `validate_session_token` in app/models/session.rb?
```

```
/why give me the lay of the land on app/controllers/api_controller.rb
```

```
/why I'm about to refactor lib/payment_gateway/client.rb — what should I know?
```
